.class public Lcom/whatsapp/yo/Conversation;
...
.field static a:Lcom/whatsapp/Conversation; = null
...
.field private static e:Lcom/whatsapp/youbasha/ui/activity/SwipeBackController;
...
.method static constructor <clinit>()V
    ...
    sput v1, Lcom/whatsapp/yo/Conversation;->j:I
    ...
    sput v1, Lcom/whatsapp/yo/Conversation;->l:I
    ...
    sput v1, Lcom/whatsapp/yo/Conversation;->m:I
    ...
    sput v1, Lcom/whatsapp/yo/Conversation;->n:I
    ...
    sput v1, Lcom/whatsapp/yo/Conversation;->o:I
    ...
    sput v1, Lcom/whatsapp/yo/Conversation;->p:I
    ...
    sput v1, Lcom/whatsapp/yo/Conversation;->q:I
    ...
    sput v1, Lcom/whatsapp/yo/Conversation;->x:I
    ...
    sput v1, Lcom/whatsapp/yo/Conversation;->y:I
    ...
    sput v1, Lcom/whatsapp/yo/Conversation;->z:I
    ...
    sput v2, Lcom/whatsapp/yo/Conversation;->A:I
    ...
    sput v1, Lcom/whatsapp/yo/Conversation;->B:I

    invoke-static {}, Lcom/whatsapp/youbasha/task/utils;->isArabic()Z

    move-result v1

    sput-boolean v1, Lcom/whatsapp/yo/Conversation;->C:Z
    ...
    sput v1, Lcom/whatsapp/yo/Conversation;->D:I
    ...
    sput v1, Lcom/whatsapp/yo/Conversation;->E:I

    const/4 v1, 0x0

    sput-object v1, Lcom/whatsapp/yo/Conversation;->F:Landroid/widget/LinearLayout$LayoutParams;

    sput-object v1, Lcom/whatsapp/yo/Conversation;->G:Landroid/widget/LinearLayout$LayoutParams;

    sput-object v1, Lcom/whatsapp/yo/Conversation;->H:Landroid/widget/LinearLayout$LayoutParams;

    sput-object v1, Lcom/whatsapp/yo/Conversation;->I:Landroid/widget/LinearLayout$LayoutParams;

    sput-object v1, Lcom/whatsapp/yo/Conversation;->J:Landroid/widget/LinearLayout$LayoutParams;
    ...
    sput v1, Lcom/whatsapp/yo/Conversation;->K:I
...
.method public static BGClip(Landroid/widget/FrameLayout;)V
    ...
    :cond_1
    invoke-static {}, Lcom/whatsapp/youbasha/store/ColorStore;->getBGColor()I
...
.method public static ModChatColor(LX/019;)V
    .locals 3

    sget-object v0, Lcom/whatsapp/yo/Conversation;->a:Lcom/whatsapp/Conversation;
    ...
    sget-object v1, Lcom/whatsapp/yo/Conversation;->a:Lcom/whatsapp/Conversation;

    new-instance v2, Lcom/whatsapp/yo/-$$Lambda$Conversation$cj8IqBYywg7Y0d1TDq189ighDP8;

    invoke-direct {v2, p0, v0}, Lcom/whatsapp/yo/-$$Lambda$Conversation$cj8IqBYywg7Y0d1TDq189ighDP8;-><init>(LX/019;Ljava/lang/String;)V

    invoke-virtual {v1, v2}, Lcom/whatsapp/Conversation;->runOnUiThread(Ljava/lang/Runnable;)V
    ...
    new-instance v2, Lcom/whatsapp/yo/-$$Lambda$Conversation$Usff2JWuBEJ9BO4GNUGCtvBkrEk;

    invoke-direct {v2, p0, v0}, Lcom/whatsapp/yo/-$$Lambda$Conversation$Usff2JWuBEJ9BO4GNUGCtvBkrEk;-><init>(LX/019;I)V
...
.method private static a(LX/1QA;)I
    .locals 1

    invoke-static {p0}, Lcom/whatsapp/yo/dep;->d(LX/1QA;)Z
...
.method static a(ZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    sget p0, Lcom/whatsapp/yo/Conversation;->j:I
...
.method private static a(Ljava/lang/String;)Landroid/view/View;
    ...
    invoke-static {p0, v1}, Lcom/whatsapp/yo/yo;->getID(Ljava/lang/String;Ljava/lang/String;)I

    move-result p0

    invoke-virtual {v0, p0}, Lcom/whatsapp/Conversation;->findViewById(I)Landroid/view/View;
...
.method private static a(Landroid/app/Activity;)Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/whatsapp/yo/yo;->isGroupJid(Ljava/lang/String;)Z

    move-result v3

    :cond_1
    :goto_0
    invoke-static {v3}, Lcom/whatsapp/yo/yo;->setGroupBoolean(Z)V
    :try_end_0
...
.method static a()V
    ...
    invoke-static {v0}, Lcom/whatsapp/yo/yo;->c(Ljava/lang/String;)[Ljava/lang/String;

    move-result-object v0

    if-eqz v0, :cond_0

    sget-object v1, Lcom/whatsapp/yo/Conversation;->b:Ljava/util/HashSet;
...
.method private static synthetic a(LX/019;I)V
    .locals 1
    ...
    invoke-virtual {p0, v0}, LX/019;->A08(Landroid/graphics/drawable/Drawable;)V

    return-void
.end method

.method private static synthetic a(LX/019;Ljava/lang/String;)V
    .locals 0
    ...
    invoke-virtual {p0, p1}, LX/019;->A08(Landroid/graphics/drawable/Drawable;)V
...
.method private static synthetic a(Landroid/app/Activity;Ljava/lang/String;Landroid/view/View;)V
    ...
    invoke-static {p0, p1}, Lcom/whatsapp/yo/Conversation;->a(Landroid/app/Activity;Ljava/lang/String;)V
    ...
    new-instance v0, Lcom/whatsapp/yo/-$$Lambda$Conversation$8jg_FXIgt4RYbBF8GvKIVUvXbys;

    invoke-direct {v0, p0, p1}, Lcom/whatsapp/yo/-$$Lambda$Conversation$8jg_FXIgt4RYbBF8GvKIVUvXbys;-><init>(Landroid/app/Activity;Ljava/lang/String;)V

    const-wide/16 v1, 0xdac

    invoke-virtual {p2, v0, v1, v2}, Landroid/os/Handler;->postDelayed(Ljava/lang/Runnable;J)Z

    new-instance v0, Lcom/whatsapp/yo/-$$Lambda$Conversation$O6qj3Zx-VbIS4YkmR3Nr8s8mGDU;

    invoke-direct {v0, p0, p1}, Lcom/whatsapp/yo/-$$Lambda$Conversation$O6qj3Zx-VbIS4YkmR3Nr8s8mGDU;-><init>(Landroid/app/Activity;Ljava/lang/String;)V

    const-wide/16 v1, 0x1d4c

    invoke-virtual {p2, v0, v1, v2}, Landroid/os/Handler;->postDelayed(Ljava/lang/Runnable;J)Z

    new-instance v0, Lcom/whatsapp/yo/-$$Lambda$Conversation$_0HF2dRMlAJOfY3cK2-uA2tPw-I;

    invoke-direct {v0, p0, p1}, Lcom/whatsapp/yo/-$$Lambda$Conversation$_0HF2dRMlAJOfY3cK2-uA2tPw-I;-><init>(Landroid/app/Activity;Ljava/lang/String;)V
...
.method private static a(Landroid/app/Activity;Z)V
    ...
    invoke-static {v2, v0}, Lcom/whatsapp/yo/yo;->getID(Ljava/lang/String;Ljava/lang/String;)I
...
.method private static a(Landroid/view/Menu;)V
    ...
    new-instance v3, Lcom/whatsapp/yo/-$$Lambda$Conversation$NbyFMSRBzuVmB_ORFSsMV15p-q0;

    invoke-direct {v3, v2, v0}, Lcom/whatsapp/yo/-$$Lambda$Conversation$NbyFMSRBzuVmB_ORFSsMV15p-q0;-><init>(Landroidx/appcompat/view/menu/ActionMenuItemView;I)V
...
.method private static synthetic a(Landroid/view/View;)V
    ...
    invoke-static {v3, v4}, Lcom/whatsapp/youbasha/others;->getColor(Ljava/lang/String;I)I
...
.method private static a(Landroid/widget/ImageView;Ljava/lang/String;)V
    ...
    iget-object v0, v0, Lcom/whatsapp/Conversation;->A0p:LX/1vO;

    invoke-direct {p1, v0}, Lcom/whatsapp/gnn;-><init>(LX/1vO;)V
    ...
    invoke-direct {p1, v0}, Lcom/whatsapp/eyy;-><init>(LX/1vO;)V
    ...
    invoke-direct {p1, v0}, Lcom/whatsapp/exx;-><init>(LX/1vO;)V
    ...
    invoke-direct {p1, v0}, Lcom/whatsapp/ezz;-><init>(LX/1vO;)V
...
.method private static synthetic a(Landroid/widget/TextView;)V
    ...
    sput-object v0, Lcom/whatsapp/yo/Conversation;->d:Ljava/lang/String;
    ...
    :cond_0
    sget-object p0, Lcom/whatsapp/yo/Conversation;->a:Lcom/whatsapp/Conversation;

    sget-object v0, Lcom/whatsapp/yo/Conversation;->d:Ljava/lang/String;

    :goto_0
    invoke-static {p0, v0}, Lcom/whatsapp/yo/yo;->a(Landroid/app/Activity;Ljava/lang/String;)V
...
.method private static synthetic a(Lcom/whatsapp/youbasha/ui/activity/specPrivacy;Landroid/widget/CompoundButton;Z)V
    .locals 0
...
.method private static synthetic a(Ljava/lang/String;Landroid/view/View;)V
    ...
    sget-object p1, Lcom/whatsapp/yo/Conversation;->a:Lcom/whatsapp/Conversation;

    invoke-static {p0}, Lcom/whatsapp/yo/Conversation;->b(Ljava/lang/String;)Landroid/content/Intent;

    move-result-object p0

    invoke-virtual {p1, p0}, Lcom/whatsapp/Conversation;->startActivity(Landroid/content/Intent;)V
...
.method private static a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/yo;->d(Ljava/lang/String;)I
    ...
    :cond_1
    invoke-static {v0, p0}, Lcom/whatsapp/yo/Conversation;->a(Landroid/widget/ImageView;Ljava/lang/String;)V

    invoke-static {v0, p0}, Lcom/whatsapp/yo/Conversation;->a(Landroid/view/View;Ljava/lang/String;)V
...
.method private static synthetic a(Landroid/view/MenuItem;)Z
    ...
    invoke-static {p0, v0}, Lcom/whatsapp/yo/Conversation;->a(Landroid/app/Activity;Ljava/lang/String;)V
...
.method public static after_onActivityResult(IILandroid/content/Intent;)V
    ...
    sput p1, Lcom/whatsapp/yo/Conversation;->c:I
...
.method public static after_onCreateOptionsMenu(Landroid/view/Menu;)V
    ...
    new-instance v1, Lcom/whatsapp/yo/-$$Lambda$Conversation$W7oaq4UcCvCkZoCfhytIWv0fHTM;

    invoke-direct {v1, p0}, Lcom/whatsapp/yo/-$$Lambda$Conversation$W7oaq4UcCvCkZoCfhytIWv0fHTM;-><init>(Landroid/view/Menu;)V

    invoke-virtual {v0, v1}, Lcom/whatsapp/Conversation;->runOnUiThread(Ljava/lang/Runnable;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static after_onDestroy(Lcom/whatsapp/Conversation;)V
    ...
    sput p0, Lcom/whatsapp/yo/Conversation;->c:I

    const/4 p0, 0x0

    sput-object p0, Lcom/whatsapp/yo/Conversation;->f:Landroid/graphics/drawable/Drawable;
...
.method public static after_onResume(Lcom/whatsapp/Conversation;)V
    ...
    :cond_0
    sput-object p0, Lcom/whatsapp/yo/Conversation;->a:Lcom/whatsapp/Conversation;

    invoke-static {}, Lcom/whatsapp/yo/Conversation;->b()V

    invoke-static {}, Lcom/whatsapp/yo/Conversation;->a()V
    ...
    sput-boolean v0, Lcom/whatsapp/yo/Conversation;->s:Z
    ...
    invoke-static {p0, v0}, Lcom/whatsapp/yo/shp;->getBoolean(Ljava/lang/String;Z)Z
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/shp;->getBoolean(Ljava/lang/String;)Z

    move-result p0

    :goto_1
    sput-boolean p0, Lcom/whatsapp/yo/Conversation;->r:Z

    const/4 p0, 0x0

    const-string v1, "pic_inside"

    invoke-static {v1, p0}, Lcom/whatsapp/yo/shp;->getBoolean(Ljava/lang/String;Z)Z

    move-result v1

    sput-boolean v1, Lcom/whatsapp/yo/Conversation;->t:Z

    if-nez v1, :cond_4

    sget-boolean v1, Lcom/whatsapp/yo/Conversation;->r:Z

    if-nez v1, :cond_3

    sget-boolean v1, Lcom/whatsapp/yo/Conversation;->s:Z
    ...
    :cond_4
    sput-boolean p0, Lcom/whatsapp/yo/Conversation;->u:Z

    const/16 p0, 0x24

    const-string v0, "pic_chat_size_pickerV2"

    invoke-static {v0, p0}, Lcom/whatsapp/yo/shp;->getPrefInt(Ljava/lang/String;I)I

    move-result v0

    sget-boolean v1, Lcom/whatsapp/yo/Conversation;->t:Z
    ...
    :goto_2
    sput p0, Lcom/whatsapp/yo/Conversation;->v:I
    ...
    sget-boolean p0, Lcom/whatsapp/yo/Conversation;->u:Z

    if-eqz p0, :cond_a

    sget-object p0, Lcom/whatsapp/yo/Conversation;->J:Landroid/widget/LinearLayout$LayoutParams;
    ...
    sput-object p0, Lcom/whatsapp/yo/Conversation;->J:Landroid/widget/LinearLayout$LayoutParams;
    ...
    :cond_6
    sget-object p0, Lcom/whatsapp/yo/Conversation;->H:Landroid/widget/LinearLayout$LayoutParams;

    if-nez p0, :cond_8

    new-instance p0, Landroid/widget/LinearLayout$LayoutParams;

    sget v0, Lcom/whatsapp/yo/Conversation;->v:I

    invoke-direct {p0, v0, v0}, Landroid/widget/LinearLayout$LayoutParams;-><init>(II)V

    sput-object p0, Lcom/whatsapp/yo/Conversation;->H:Landroid/widget/LinearLayout$LayoutParams;

    sget-boolean p0, Lcom/whatsapp/yo/Conversation;->C:Z

    if-eqz p0, :cond_7

    sget-object p0, Lcom/whatsapp/yo/Conversation;->H:Landroid/widget/LinearLayout$LayoutParams;

    sget v0, Lcom/whatsapp/yo/Conversation;->D:I
    ...
    :cond_8
    :goto_3
    sget-object p0, Lcom/whatsapp/yo/Conversation;->I:Landroid/widget/LinearLayout$LayoutParams;
    ...
    sput-object p0, Lcom/whatsapp/yo/Conversation;->I:Landroid/widget/LinearLayout$LayoutParams;
    ...
    sput v0, Lcom/whatsapp/yo/Conversation;->g:I
...
.method public static after_onStart(Lcom/whatsapp/Conversation;)V
    ...
    sput-object v0, Lcom/whatsapp/yo/Conversation;->b:Ljava/util/HashSet;
    ...
    sget v1, Lcom/whatsapp/yo/Conversation;->c:I
    ...
    sget-object v0, Lcom/whatsapp/yo/Conversation;->f:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0}, Lcom/whatsapp/yo/Conversation;->a(Ljava/lang/String;)Landroid/view/View;
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/Conversation;->BGClip(Landroid/widget/FrameLayout;)V

    const-string p0, "ModChaSendColor"

    const-string v1, "send"

    invoke-static {v1, p0}, Lcom/whatsapp/yo/Conversation;->a(Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "emoji_picker_btn"

    const-string v3, "ModChatBtnColor"

    invoke-static {v1, v3}, Lcom/whatsapp/yo/Conversation;->a(Ljava/lang/String;Ljava/lang/String;)V

    const-string v4, "ModChatEmojiColor"

    invoke-static {v1, v4}, Lcom/whatsapp/yo/Conversation;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v4}, Lcom/whatsapp/yo/shp;->getPrefString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/Conversation;->a(Ljava/lang/String;)Landroid/view/View;
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/Conversation;->tvBalloons(Landroid/widget/TextView;)V
    ...
    invoke-static {v1}, Lcom/whatsapp/yo/yo;->d(Ljava/lang/String;)I
    ...
    invoke-static {}, Lcom/whatsapp/yo/yo;->manjatpagercolor()I

    move-result v2

    invoke-virtual {v1, v2}, Landroid/widget/TextView;->setTextColor(I)V

    new-instance v2, Lcom/whatsapp/yo/-$$Lambda$Conversation$_GRxB1IeyfksEogB4R9FXb0aZY4;

    invoke-direct {v2, v1}, Lcom/whatsapp/yo/-$$Lambda$Conversation$_GRxB1IeyfksEogB4R9FXb0aZY4;-><init>(Landroid/widget/TextView;)V
    ...
    invoke-static {}, Lcom/whatsapp/yo/yo;->manjatpagercolor2()I
    ...
    :cond_6
    invoke-static {}, Lcom/whatsapp/yo/yo;->c()V
    ...
    sput-object p0, Lcom/whatsapp/yo/Conversation;->e:Lcom/whatsapp/youbasha/ui/activity/SwipeBackController;
...
.method private static b()V
    ...
    invoke-static {v0}, Lcom/whatsapp/yo/dep;->getJID_t(Lcom/whatsapp/jid/Jid;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/whatsapp/yo/Conversation;->a(Landroid/app/Activity;)Ljava/lang/String;
...
.method private static synthetic b(Landroid/app/Activity;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1}, Lcom/whatsapp/yo/Conversation;->a(Landroid/app/Activity;Z)V
...
.method private static synthetic b(Landroid/view/Menu;)V
    ...
    const-string v2, "go_to_first_msg"
    ...
    invoke-interface {p0, v3, v0, v4, v2}, Landroid/view/Menu;->add(IIII)Landroid/view/MenuItem;

    move-result-object v2

    sget-object v5, Lcom/whatsapp/yo/-$$Lambda$Conversation$g8WBzVWHA1RRcjadxUFckBa0TsY;->INSTANCE:Lcom/whatsapp/yo/-$$Lambda$Conversation$g8WBzVWHA1RRcjadxUFckBa0TsY;
    ...
    const-string v5, "edit_group_description_dialog_title"
    ...
    const-string v6, "settings_two_factor_auth_disable"

    goto :goto_0

    :cond_0
    const-string v6, "settings_two_factor_auth_enable"
    ...
    invoke-interface {p0, v2, v0, v4, v5}, Landroid/view/Menu;->add(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;

    move-result-object v2

    sget-object v5, Lcom/whatsapp/yo/-$$Lambda$Conversation$bLiqL8XxZY43fG2XOAQaiA_2i9c;->INSTANCE:Lcom/whatsapp/yo/-$$Lambda$Conversation$bLiqL8XxZY43fG2XOAQaiA_2i9c;
    ...
    sget-object v3, Lcom/whatsapp/yo/-$$Lambda$Conversation$VSxP0cbtSXZtOoqDEgtinqgEY4Q;->INSTANCE:Lcom/whatsapp/yo/-$$Lambda$Conversation$VSxP0cbtSXZtOoqDEgtinqgEY4Q;
    ...
    invoke-static {v3, v1}, Lcom/whatsapp/yo/yo;->getID(Ljava/lang/String;Ljava/lang/String;)I

    move-result v3

    invoke-interface {p0, v2, v0, v4, v3}, Landroid/view/Menu;->add(IIII)Landroid/view/MenuItem;

    move-result-object v2

    sget-object v3, Lcom/whatsapp/yo/-$$Lambda$Conversation$ECGykWI9XCsYbfKBn0NUv0LcEPs;->INSTANCE:Lcom/whatsapp/yo/-$$Lambda$Conversation$ECGykWI9XCsYbfKBn0NUv0LcEPs;
    ...
    invoke-static {v3}, Lcom/whatsapp/youbasha/ui/lockV2/LockUtils;->isJIDLocked(Ljava/lang/String;)Z
    ...
    invoke-interface {p0, v2, v0, v4, v1}, Landroid/view/Menu;->add(IIII)Landroid/view/MenuItem;

    move-result-object v0

    sget-object v1, Lcom/whatsapp/yo/-$$Lambda$Conversation$6LvpEI1hxubuyAMyccIppJa-7U8;->INSTANCE:Lcom/whatsapp/yo/-$$Lambda$Conversation$6LvpEI1hxubuyAMyccIppJa-7U8;

    invoke-interface {v0, v1}, Landroid/view/MenuItem;->setOnMenuItemClickListener(Landroid/view/MenuItem$OnMenuItemClickListener;)Landroid/view/MenuItem;

    invoke-static {p0}, Lcom/whatsapp/yo/Conversation;->a(Landroid/view/Menu;)V
...
.method private static synthetic b(Landroid/view/MenuItem;)Z
    ...
    sget-object v1, Lcom/whatsapp/yo/-$$Lambda$Conversation$VTozseNFjwjDrqILqYFyz1CDdqk;->INSTANCE:Lcom/whatsapp/yo/-$$Lambda$Conversation$VTozseNFjwjDrqILqYFyz1CDdqk;
    ...
    sget-object v1, Lcom/whatsapp/yo/-$$Lambda$Conversation$3ItovdkfgyngJii18zTiXbeZxpY;->INSTANCE:Lcom/whatsapp/yo/-$$Lambda$Conversation$3ItovdkfgyngJii18zTiXbeZxpY;
...
.method private static synthetic c(Landroid/view/MenuItem;)Z
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/yo;->b(Landroid/app/Activity;)V
...
.method public static checkEntryBK(Lcom/whatsapp/Conversation;ILandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    .locals 4
    ...
    sget-object p1, Lcom/whatsapp/yo/Conversation;->f:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, v2}, Lcom/whatsapp/yo/yo;->getID(Ljava/lang/String;Ljava/lang/String;)I

    move-result p1

    invoke-virtual {p0, p1}, Lcom/whatsapp/Conversation;->findViewById(I)Landroid/view/View;
    ...
    :cond_0
    sget-object p0, Lcom/whatsapp/yo/Conversation;->f:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, v1}, Lcom/whatsapp/youbasha/others;->getColor(Ljava/lang/String;I)I
...
.method public static convoBackground(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {v1}, Lcom/whatsapp/yo/Conversation;->a(Ljava/lang/String;)Landroid/view/View;
    ...
    sget-object v3, Lcom/whatsapp/yo/Conversation;->a:Lcom/whatsapp/Conversation;

    invoke-virtual {v3}, Lcom/whatsapp/Conversation;->getCacheDir()Ljava/io/File;
    ...
    invoke-virtual {v0, p0}, Lcom/whatsapp/wallpaper/WallPaperView;->setDrawable(Landroid/graphics/drawable/Drawable;)V

    sget-object p0, Landroid/widget/ImageView$ScaleType;->CENTER_CROP:Landroid/widget/ImageView$ScaleType;

    invoke-virtual {v0, p0}, Lcom/whatsapp/wallpaper/WallPaperView;->setScaleType(Landroid/widget/ImageView$ScaleType;)V
...
.method private static synthetic d(Landroid/view/MenuItem;)Z
    ...
    invoke-static {p0, v0}, Lcom/whatsapp/yo/shp;->setBooleanPriv(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, v0, v0}, Lcom/whatsapp/Conversation;->overridePendingTransition(II)V

    :cond_0
    return v1
.end method

.method public static doc_paintDetails(LX/1wE;Landroid/widget/TextView;)V
    .locals 1
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/Conversation;->a(LX/1QA;)I
...
.method public static doc_paintTitle(LX/1wE;Landroid/widget/TextView;)V
    .locals 1
    ...
    sget p0, Lcom/whatsapp/yo/yo;->a:I
    ...
    sget p0, Lcom/whatsapp/yo/yo;->b:I
...
.method private static synthetic e(Landroid/view/MenuItem;)Z
    ...
    new-instance p0, Lcom/whatsapp/yo/d;
    ...
    invoke-direct {p0, v0, v1}, Lcom/whatsapp/yo/d;-><init>(Lcom/whatsapp/Conversation;Ljava/lang/String;)V

    const/4 v0, 0x0

    new-array v0, v0, [Ljava/lang/String;

    invoke-virtual {p0, v0}, Lcom/whatsapp/yo/d;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method public static getBubbleMargin(Landroid/view/ViewGroup;I)I
    ...
    sget p0, Lcom/whatsapp/yo/Conversation;->M:I
...
.method public static getHyperlinksColor(II)I
    ...
    invoke-static {v0}, Lcom/whatsapp/yo/yo;->d(Ljava/lang/String;)I
...
.method public static getswp()Lcom/whatsapp/youbasha/ui/activity/SwipeBackController;
    ...
    sget-object v0, Lcom/whatsapp/yo/Conversation;->e:Lcom/whatsapp/youbasha/ui/activity/SwipeBackController;
...
.method public static isSwipeBackEnabled()Z
    ...
    invoke-static {v1, v0}, Lcom/whatsapp/yo/shp;->getBooleanPriv(Ljava/lang/String;Z)Z
...
.method public static synthetic lambda$3ItovdkfgyngJii18zTiXbeZxpY(Landroid/content/DialogInterface;I)V
    ...
    invoke-static {p0, p1}, Lcom/whatsapp/yo/Conversation;->a(Landroid/content/DialogInterface;I)V
...
.method public static synthetic lambda$6LvpEI1hxubuyAMyccIppJa-7U8(Landroid/view/MenuItem;)Z
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/Conversation;->a(Landroid/view/MenuItem;)Z
...
.method public static synthetic lambda$8jg_FXIgt4RYbBF8GvKIVUvXbys(Landroid/app/Activity;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1}, Lcom/whatsapp/yo/Conversation;->d(Landroid/app/Activity;Ljava/lang/String;)V
...
.method public static synthetic lambda$E3gGWLxbZ79GguNt5XCokL3_kDo(Landroid/view/View;)V
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/Conversation;->b(Landroid/view/View;)V
...
.method public static synthetic lambda$ECGykWI9XCsYbfKBn0NUv0LcEPs(Landroid/view/MenuItem;)Z
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/Conversation;->b(Landroid/view/MenuItem;)Z
...
.method public static synthetic lambda$HRZj3HVU5juyzGwuvcDY6NjxH68(Landroid/app/Activity;Ljava/lang/String;Landroid/view/View;)V
    ...
    invoke-static {p0, p1, p2}, Lcom/whatsapp/yo/Conversation;->a(Landroid/app/Activity;Ljava/lang/String;Landroid/view/View;)V
...
.method public static synthetic lambda$Hp_I3Eaee3hftI5Sy12iPh6DJg0(Ljava/lang/String;Landroid/view/View;)V
    ...
    invoke-static {p0, p1}, Lcom/whatsapp/yo/Conversation;->a(Ljava/lang/String;Landroid/view/View;)V
...
.method public static synthetic lambda$NbyFMSRBzuVmB_ORFSsMV15p-q0(Landroidx/appcompat/view/menu/ActionMenuItemView;I)V
    ...
    invoke-static {p0, p1}, Lcom/whatsapp/yo/Conversation;->a(Landroidx/appcompat/view/menu/ActionMenuItemView;I)V
...
.method public static synthetic lambda$O6qj3Zx-VbIS4YkmR3Nr8s8mGDU(Landroid/app/Activity;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1}, Lcom/whatsapp/yo/Conversation;->c(Landroid/app/Activity;Ljava/lang/String;)V

    return-void
.end method

.method public static synthetic lambda$Usff2JWuBEJ9BO4GNUGCtvBkrEk(LX/019;I)V
    .locals 0

    invoke-static {p0, p1}, Lcom/whatsapp/yo/Conversation;->a(LX/019;I)V
...
.method public static synthetic lambda$VSxP0cbtSXZtOoqDEgtinqgEY4Q(Landroid/view/MenuItem;)Z
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/Conversation;->c(Landroid/view/MenuItem;)Z
...
.method public static synthetic lambda$VTozseNFjwjDrqILqYFyz1CDdqk(Landroid/content/DialogInterface;I)V
    ...
    invoke-static {p0, p1}, Lcom/whatsapp/yo/Conversation;->b(Landroid/content/DialogInterface;I)V
...
.method public static synthetic lambda$W7oaq4UcCvCkZoCfhytIWv0fHTM(Landroid/view/Menu;)V
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/Conversation;->b(Landroid/view/Menu;)V
...
.method public static synthetic lambda$WrGintUkYyUCReCAVC_7Bc3RoTU(Ljava/lang/String;Landroid/widget/CompoundButton;Z)V
    ...
    invoke-static {p0, p1, p2}, Lcom/whatsapp/yo/Conversation;->b(Ljava/lang/String;Landroid/widget/CompoundButton;Z)V
...
.method public static synthetic lambda$Zyb3taREoXeoUVHqtjo_bCKEb_A(Ljava/lang/String;Landroid/view/View;)V
    ...
    invoke-static {p0, p1}, Lcom/whatsapp/yo/Conversation;->b(Ljava/lang/String;Landroid/view/View;)V
...
.method public static synthetic lambda$_0HF2dRMlAJOfY3cK2-uA2tPw-I(Landroid/app/Activity;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1}, Lcom/whatsapp/yo/Conversation;->b(Landroid/app/Activity;Ljava/lang/String;)V

    return-void
.end method

.method public static synthetic lambda$_AL8kmyHrovBEMLsqiUKiQJodKE(Lcom/whatsapp/youbasha/ui/activity/specPrivacy;Landroid/widget/CompoundButton;Z)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/whatsapp/yo/Conversation;->a(Lcom/whatsapp/youbasha/ui/activity/specPrivacy;Landroid/widget/CompoundButton;Z)V
...
.method public static synthetic lambda$_GRxB1IeyfksEogB4R9FXb0aZY4(Landroid/widget/TextView;)V
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/Conversation;->a(Landroid/widget/TextView;)V
...
.method public static synthetic lambda$bLiqL8XxZY43fG2XOAQaiA_2i9c(Landroid/view/MenuItem;)Z
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/Conversation;->d(Landroid/view/MenuItem;)Z
...
.method public static synthetic lambda$cj8IqBYywg7Y0d1TDq189ighDP8(LX/019;Ljava/lang/String;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/whatsapp/yo/Conversation;->a(LX/019;Ljava/lang/String;)V

    return-void
.end method

.method public static synthetic lambda$g8WBzVWHA1RRcjadxUFckBa0TsY(Landroid/view/MenuItem;)Z
    .locals 0

    invoke-static {p0}, Lcom/whatsapp/yo/Conversation;->e(Landroid/view/MenuItem;)Z
...
.method public static synthetic lambda$hGUzBJYcOhNDjSc-sW64DVGy2ug(Ljava/lang/String;Landroid/widget/CompoundButton;Z)V
    ...
    invoke-static {p0, p1, p2}, Lcom/whatsapp/yo/Conversation;->a(Ljava/lang/String;Landroid/widget/CompoundButton;Z)V
...
.method public static synthetic lambda$iIuLCfwsgeL3MRv6UOcpvHiDx9w(Landroid/view/View;)V
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/Conversation;->a(Landroid/view/View;)V
...
.method public static synthetic lambda$tSoMzVv6-Z9geWUiJ54Kh7vcBbU(Ljava/lang/String;Landroid/widget/CompoundButton;Z)V
    ...
    invoke-static {p0, p1, p2}, Lcom/whatsapp/yo/Conversation;->c(Ljava/lang/String;Landroid/widget/CompoundButton;Z)V
...
.method public static leftlayID(I)I
    ...
    sget-boolean v0, Lcom/whatsapp/yo/Conversation;->r:Z

    if-eqz v0, :cond_0

    sget p0, Lcom/whatsapp/yo/Conversation;->B:I
...
.method public static pNotifi(LX/1QA;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    .locals 1

    :try_start_0
    invoke-static {p0}, Lcom/whatsapp/yo/dep;->b(LX/1QA;)Ljava/lang/String;
...
.method public static pNotifi(LX/1QA;Ljava/lang/String;)Ljava/lang/String;
    .locals 1
...
.method public static pageDescColor(Landroid/view/View;)V
    ...
    :try_start_0
    new-instance v0, Lcom/whatsapp/yo/-$$Lambda$Conversation$iIuLCfwsgeL3MRv6UOcpvHiDx9w;

    invoke-direct {v0, p0}, Lcom/whatsapp/yo/-$$Lambda$Conversation$iIuLCfwsgeL3MRv6UOcpvHiDx9w;-><init>(Landroid/view/View;)V
...
.method public static paintForwarded(Landroid/widget/TextView;LX/1QA;)V
    .locals 1

    invoke-static {p1}, Lcom/whatsapp/yo/Conversation;->a(LX/1QA;)I
...
.method public static rightlayID(I)I
    ...
    sget-boolean v0, Lcom/whatsapp/yo/Conversation;->s:Z

    if-eqz v0, :cond_0

    sget p0, Lcom/whatsapp/yo/Conversation;->A:I
...
.method public static setCInPicResize(Landroid/view/ViewGroup;)V
    ...
    sget v1, Lcom/whatsapp/yo/Conversation;->v:I
...
.method public static setCPic(Landroid/view/ViewGroup;LX/1QA;I)V
    .locals 3

    :try_start_0
    invoke-static {p1}, Lcom/whatsapp/yo/dep;->d(LX/1QA;)Z

    move-result v0

    if-eqz v0, :cond_0

    sget-object p1, Lcom/whatsapp/yo/dep;->myNum:Ljava/lang/String;
    ...
    :try_start_1
    invoke-static {p1}, Lcom/whatsapp/yo/dep;->a(LX/1QA;)Ljava/lang/String;
    ...
    :cond_2
    invoke-static {p1}, Lcom/whatsapp/yo/dep;->b(LX/1QA;)Ljava/lang/String;
    ...
    :try_start_2
    sget v0, Lcom/whatsapp/yo/Conversation;->z:I
    ...
    new-instance p2, Lcom/whatsapp/yo/-$$Lambda$Conversation$Zyb3taREoXeoUVHqtjo_bCKEb_A;

    invoke-direct {p2, p1}, Lcom/whatsapp/yo/-$$Lambda$Conversation$Zyb3taREoXeoUVHqtjo_bCKEb_A;-><init>(Ljava/lang/String;)V
    ...
    :cond_9
    sget-boolean p2, Lcom/whatsapp/yo/Conversation;->t:Z
    :try_end_3
    ...
    :try_start_4
    sget p2, Lcom/whatsapp/yo/Conversation;->x:I
    ...
    :cond_b
    sget-boolean p2, Lcom/whatsapp/yo/Conversation;->r:Z
    ...
    new-instance p2, Lcom/whatsapp/yo/-$$Lambda$Conversation$Hp_I3Eaee3hftI5Sy12iPh6DJg0;

    invoke-direct {p2, p1}, Lcom/whatsapp/yo/-$$Lambda$Conversation$Hp_I3Eaee3hftI5Sy12iPh6DJg0;-><init>(Ljava/lang/String;)V
...
.method public static setChatDateColor(Landroid/widget/TextView;LX/1QA;)V
    .locals 0
...
.method public static setChatInfo(Landroid/app/Activity;)V
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/Conversation;->a(Landroid/app/Activity;)Ljava/lang/String;

    move-result-object v2

    invoke-static {v2}, Lcom/whatsapp/yo/yo;->setCurr_sJid(Ljava/lang/String;)V
    ...
    :try_start_1
    new-instance v4, Lcom/whatsapp/youbasha/ui/activity/specPrivacy;

    invoke-direct {v4, p0, v3}, Lcom/whatsapp/youbasha/ui/activity/specPrivacy;-><init>(Landroid/app/Activity;Ljava/lang/String;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_1
    ...
    invoke-virtual {v4, v5}, Lcom/whatsapp/youbasha/ui/activity/specPrivacy;->setSW(Landroid/widget/CompoundButton;)V
    :try_end_2
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_2} :catch_0
    ...
    invoke-static {v5, v1}, Lcom/whatsapp/yo/yo;->getID(Ljava/lang/String;Ljava/lang/String;)I
    ...
    new-instance v5, Lcom/whatsapp/yo/-$$Lambda$Conversation$_AL8kmyHrovBEMLsqiUKiQJodKE;

    invoke-direct {v5, v4}, Lcom/whatsapp/yo/-$$Lambda$Conversation$_AL8kmyHrovBEMLsqiUKiQJodKE;-><init>(Lcom/whatsapp/youbasha/ui/activity/specPrivacy;)V
    ...
    new-instance v7, Lcom/whatsapp/yo/-$$Lambda$Conversation$tSoMzVv6-Z9geWUiJ54Kh7vcBbU;

    invoke-direct {v7, v6}, Lcom/whatsapp/yo/-$$Lambda$Conversation$tSoMzVv6-Z9geWUiJ54Kh7vcBbU;-><init>(Ljava/lang/String;)V
    ...
    :cond_1
    :goto_0
    invoke-static {v3}, Lcom/whatsapp/yo/yo;->isGroupJid(Ljava/lang/String;)Z
    ...
    invoke-static {v3}, Lcom/whatsapp/youbasha/ui/activity/CallsPrivacy;->isContactCustomBlocked(Ljava/lang/String;)Z

    move-result v6

    invoke-virtual {v0, v6}, Landroidx/appcompat/widget/SwitchCompat;->setChecked(Z)V

    new-instance v6, Lcom/whatsapp/yo/-$$Lambda$Conversation$WrGintUkYyUCReCAVC_7Bc3RoTU;

    invoke-direct {v6, v3}, Lcom/whatsapp/yo/-$$Lambda$Conversation$WrGintUkYyUCReCAVC_7Bc3RoTU;-><init>(Ljava/lang/String;)V
    ...
    new-instance v4, Lcom/whatsapp/yo/-$$Lambda$Conversation$hGUzBJYcOhNDjSc-sW64DVGy2ug;

    invoke-direct {v4, v3}, Lcom/whatsapp/yo/-$$Lambda$Conversation$hGUzBJYcOhNDjSc-sW64DVGy2ug;-><init>(Ljava/lang/String;)V
    ...
    new-instance v3, Lcom/whatsapp/yo/-$$Lambda$Conversation$HRZj3HVU5juyzGwuvcDY6NjxH68;

    invoke-direct {v3, p0, v1}, Lcom/whatsapp/yo/-$$Lambda$Conversation$HRZj3HVU5juyzGwuvcDY6NjxH68;-><init>(Landroid/app/Activity;Ljava/lang/String;)V

    invoke-virtual {v0, v3}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-static {v2}, Lcom/whatsapp/youbasha/ui/lockV2/LockUtils;->isJIDLocked(Ljava/lang/String;)Z

    move-result v0

    invoke-static {p0, v0}, Lcom/whatsapp/yo/Conversation;->a(Landroid/app/Activity;Z)V
    :try_end_4
...
.method public static setEmPopup(Landroid/view/View;)V
    ...
    sget v3, Lcom/whatsapp/yo/Conversation;->o:I
    ...
    sget v3, Lcom/whatsapp/yo/Conversation;->q:I
    ...
    sget v1, Lcom/whatsapp/yo/Conversation;->p:I
    ...
    invoke-static {v3, v5}, Lcom/whatsapp/yo/yo;->getID(Ljava/lang/String;Ljava/lang/String;)I
...
.method public static setPicO(Landroid/view/ViewGroup;LX/1QA;)Landroid/view/View;
    .locals 7
    ...
    sget-boolean v2, Lcom/whatsapp/yo/Conversation;->u:Z
    ...
    sget-boolean v2, Lcom/whatsapp/yo/Conversation;->r:Z
    ...
    sget v3, Lcom/whatsapp/yo/Conversation;->K:I

    if-ne v2, v3, :cond_5

    sget v2, Lcom/whatsapp/yo/Conversation;->L:I
    ...
    sget v4, Lcom/whatsapp/yo/Conversation;->E:I

    sget v5, Lcom/whatsapp/yo/Conversation;->v:I
    ...
    sget-object v5, Lcom/whatsapp/yo/Conversation;->G:Landroid/widget/LinearLayout$LayoutParams;
    ...
    sput-object v5, Lcom/whatsapp/yo/Conversation;->G:Landroid/widget/LinearLayout$LayoutParams;
    ...
    :cond_8
    sget-boolean v4, Lcom/whatsapp/yo/Conversation;->C:Z

    if-eqz v4, :cond_9

    sget-object v4, Lcom/whatsapp/yo/Conversation;->G:Landroid/widget/LinearLayout$LayoutParams;
    ...
    sget v6, Lcom/whatsapp/yo/Conversation;->D:I
    ...
    sget v5, Lcom/whatsapp/yo/Conversation;->E:I
    ...
    :cond_a
    sget-object v5, Lcom/whatsapp/yo/Conversation;->F:Landroid/widget/LinearLayout$LayoutParams;
    ...
    sput-object v5, Lcom/whatsapp/yo/Conversation;->F:Landroid/widget/LinearLayout$LayoutParams;
    ...
    sget-object v4, Lcom/whatsapp/yo/Conversation;->F:Landroid/widget/LinearLayout$LayoutParams;
    ...
    sget-object v4, Lcom/whatsapp/yo/Conversation;->J:Landroid/widget/LinearLayout$LayoutParams;
    ...
    sget v3, Lcom/whatsapp/yo/Conversation;->z:I

    invoke-virtual {v1, v3}, Landroid/widget/ImageView;->setId(I)V

    if-eqz p1, :cond_f

    sget-object p1, Lcom/whatsapp/yo/Conversation;->I:Landroid/widget/LinearLayout$LayoutParams;
    ...
    :cond_f
    sget-object p1, Lcom/whatsapp/yo/Conversation;->H:Landroid/widget/LinearLayout$LayoutParams;
...
.method public static setQView(Landroid/view/View;)V
    ...
    :cond_1
    :goto_0
    sget v0, Lcom/whatsapp/yo/Conversation;->g:I
    ...
    sget v1, Lcom/whatsapp/yo/Conversation;->g:I
    ...
    new-instance v0, Lcom/whatsapp/yo/-$$Lambda$Conversation$E3gGWLxbZ79GguNt5XCokL3_kDo;

    invoke-direct {v0, p0}, Lcom/whatsapp/yo/-$$Lambda$Conversation$E3gGWLxbZ79GguNt5XCokL3_kDo;-><init>(Landroid/view/View;)V
...
.method public static setStkrBalloon(LX/1wE;Landroid/view/ViewGroup;Landroid/graphics/drawable/Drawable;)V
    .locals 0
    ...
    invoke-static {p0, p2}, Lcom/whatsapp/yo/Conversation;->a(ZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
