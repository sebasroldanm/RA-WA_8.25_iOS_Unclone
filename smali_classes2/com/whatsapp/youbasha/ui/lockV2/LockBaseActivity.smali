...
.method private synthetic a(Landroid/view/View;)V
    ...
    invoke-virtual {p0}, Lcom/whatsapp/youbasha/ui/lockV2/LockBaseActivity;->onBackPressed()V
...
.method private synthetic a(Landroid/widget/EditText;Landroid/content/DialogInterface;I)V
    ...
    invoke-static {p1}, Lcom/whatsapp/youbasha/ui/lockV2/RecoveryQuestion;->a(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/whatsapp/youbasha/ui/lockV2/LockBaseActivity;->StartClass(Ljava/lang/Class;)V
    ...
    invoke-virtual {p0}, Lcom/whatsapp/youbasha/ui/lockV2/LockBaseActivity;->finish()V
...
.method public static synthetic lambda$V1linEHFtfXGEgElRPql4megILU(Landroid/content/DialogInterface;I)V
    ...
    invoke-static {p0, p1}, Lcom/whatsapp/youbasha/ui/lockV2/LockBaseActivity;->a(Landroid/content/DialogInterface;I)V
...
.method public static synthetic lambda$mxCjXlq2voNEPyIPriBR5B2ckJ8(Landroid/app/Activity;Landroid/view/View;)V
    ...
    invoke-static {p0, p1}, Lcom/whatsapp/youbasha/ui/lockV2/LockBaseActivity;->a(Landroid/app/Activity;Landroid/view/View;)V

    return-void
.end method

.method public static synthetic lambda$oJls7GGnSYrq0z1m6uOibH4UPKU(Lcom/whatsapp/youbasha/ui/lockV2/LockBaseActivity;Landroid/view/View;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/whatsapp/youbasha/ui/lockV2/LockBaseActivity;->a(Landroid/view/View;)V

    return-void
.end method

.method public static synthetic lambda$tTUpTKnEPBFvQtg8bNwbDoP2QKo(Lcom/whatsapp/youbasha/ui/lockV2/LockBaseActivity;Landroid/widget/EditText;Landroid/content/DialogInterface;I)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/whatsapp/youbasha/ui/lockV2/LockBaseActivity;->a(Landroid/widget/EditText;Landroid/content/DialogInterface;I)V
...
.method protected StartClass(Ljava/lang/Class;)V
    ...
    invoke-virtual {p0, v0}, Lcom/whatsapp/youbasha/ui/lockV2/LockBaseActivity;->startActivity(Landroid/content/Intent;)V
...
.method public auth_success()V
    ...
    invoke-virtual {p0, v0}, Lcom/whatsapp/youbasha/ui/lockV2/LockBaseActivity;->setResult(I)V
    ...
    invoke-virtual {v0}, Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;->getIsDisableLock()Z
    ...
    invoke-virtual {v0}, Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;->getIsConversation()Z
    ...
    invoke-virtual {v0}, Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;->getJustCloseAfterSuccess()Z
    ...
    invoke-virtual {v0}, Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;->hasIntent()Z
    ...
    invoke-virtual {v0}, Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;->getPassedIntent()Landroid/content/Intent;
    ...
    invoke-virtual {p0, v0}, Lcom/whatsapp/youbasha/ui/lockV2/LockBaseActivity;->StartClass(Ljava/lang/Class;)V
...
.method public init(Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-virtual {p0, v0}, Lcom/whatsapp/youbasha/ui/lockV2/LockBaseActivity;->setRequestedOrientation(I)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {p0}, Lcom/whatsapp/youbasha/ui/lockV2/LockBaseActivity;->getIntent()Landroid/content/Intent;
    ...
    invoke-static {v0, p1}, Lcom/whatsapp/youbasha/others;->getID(Ljava/lang/String;Ljava/lang/String;)I

    move-result v0

    invoke-virtual {p0, v0}, Lcom/whatsapp/youbasha/ui/lockV2/LockBaseActivity;->findViewById(I)Landroid/view/View;
    ...
    invoke-virtual {p0, p1}, Lcom/whatsapp/youbasha/ui/lockV2/LockBaseActivity;->findViewById(I)Landroid/view/View;
    ...
    new-instance v0, Lcom/whatsapp/youbasha/ui/lockV2/-$$Lambda$LockBaseActivity$oJls7GGnSYrq0z1m6uOibH4UPKU;

    invoke-direct {v0, p0}, Lcom/whatsapp/youbasha/ui/lockV2/-$$Lambda$LockBaseActivity$oJls7GGnSYrq0z1m6uOibH4UPKU;-><init>(Lcom/whatsapp/youbasha/ui/lockV2/LockBaseActivity;)V
    ...
    new-instance v0, Lcom/whatsapp/youbasha/ui/lockV2/-$$Lambda$LockBaseActivity$mxCjXlq2voNEPyIPriBR5B2ckJ8;

    invoke-direct {v0, p0}, Lcom/whatsapp/youbasha/ui/lockV2/-$$Lambda$LockBaseActivity$mxCjXlq2voNEPyIPriBR5B2ckJ8;-><init>(Landroid/app/Activity;)V
...
.method public reset_lock()V
    ...
    invoke-static {p0}, Lcom/whatsapp/youbasha/ui/lockV2/RecoveryQuestion;->a(Landroid/app/Activity;)Landroid/app/AlertDialog$Builder;
    ...
    new-instance v3, Lcom/whatsapp/youbasha/ui/lockV2/-$$Lambda$LockBaseActivity$tTUpTKnEPBFvQtg8bNwbDoP2QKo;

    invoke-direct {v3, p0, v0}, Lcom/whatsapp/youbasha/ui/lockV2/-$$Lambda$LockBaseActivity$tTUpTKnEPBFvQtg8bNwbDoP2QKo;-><init>(Lcom/whatsapp/youbasha/ui/lockV2/LockBaseActivity;Landroid/widget/EditText;)V

    invoke-virtual {v1, v2, v3}, Landroid/app/AlertDialog$Builder;->setPositiveButton(ILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;

    const/high16 v0, 0x1040000

    sget-object v2, Lcom/whatsapp/youbasha/ui/lockV2/-$$Lambda$LockBaseActivity$V1linEHFtfXGEgElRPql4megILU;->INSTANCE:Lcom/whatsapp/youbasha/ui/lockV2/-$$Lambda$LockBaseActivity$V1linEHFtfXGEgElRPql4megILU;
