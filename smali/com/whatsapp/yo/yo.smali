.class public Lcom/whatsapp/yo/yo;
.super Lcom/whatsapp/yo/dep;


# static fields
.field public static Homeac:Lcom/whatsapp/HomeActivity; = null

.field static c:Landroid/database/sqlite/SQLiteOpenHelper; = null
...
.field public static mIGStatusesFragment:Lcom/whatsapp/youbasha/ui/views/IGStatusesFragment; = null

.field public static final mpack:Ljava/lang/String; = "com.whatsapp"
...
.field public static final pname:Ljava/lang/String; = "WhatsApp"
...
.method static constructor <clinit>()V
    ...
    const-class v0, Lcom/whatsapp/yo/ids;

    sput-object v0, Lcom/whatsapp/yo/yo;->e:Ljava/lang/Class;

    const-class v0, Lcom/whatsapp/yo/freqids;

    sput-object v0, Lcom/whatsapp/yo/yo;->f:Ljava/lang/Class;

    const/4 v0, -0x1

    sput v0, Lcom/whatsapp/yo/yo;->i:I

    const/4 v0, 0x0

    sput-boolean v0, Lcom/whatsapp/yo/yo;->j:Z
    ...
    sput-object v1, Lcom/whatsapp/yo/yo;->k:Landroid/widget/TextView;

    sput-object v1, Lcom/whatsapp/yo/yo;->l:Landroid/app/Activity;

    sput-boolean v0, Lcom/whatsapp/yo/yo;->m:Z

    sput-object v1, Lcom/whatsapp/yo/yo;->n:Landroid/os/Vibrator;

    sput-boolean v0, Lcom/whatsapp/yo/yo;->q:Z
...
.method public constructor <init>()V
    ...
    invoke-direct {p0}, Lcom/whatsapp/yo/dep;-><init>()V
...
.method public static ArchivedChats(Landroid/app/Activity;)V
    ...
    invoke-static {v0}, Lcom/whatsapp/yo/yo;->a(Ljava/lang/CharSequence;)Landroid/text/SpannableString;
...
.method public static BlueTi(Lcom/whatsapp/jobqueue/job/SendReadReceiptJob;)Z
    .locals 4
    ...
    invoke-static {v1}, Lcom/whatsapp/yo/shp;->removePrivKey(Ljava/lang/String;)V

    iget-object v0, p0, Lcom/whatsapp/jobqueue/job/SendReadReceiptJob;->jid:Ljava/lang/String;

    iget-object p0, p0, Lcom/whatsapp/jobqueue/job/SendReadReceiptJob;->messageIds:[Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lcom/whatsapp/yo/yo;->a(Ljava/lang/String;[Ljava/lang/String;)V

    :cond_1
    iget-object p0, p0, Lcom/whatsapp/jobqueue/job/SendReadReceiptJob;->jid:Ljava/lang/String;
...
.method public static BubbleStyle(Landroid/content/Context;II)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v2}, Lcom/whatsapp/yo/yo;->f(Ljava/lang/String;)I
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/yo;->f(Ljava/lang/String;)I
    ...
    invoke-static {v0}, Lcom/whatsapp/yo/yo;->f(Ljava/lang/String;)I
    ...
    invoke-static {v1}, Lcom/whatsapp/yo/yo;->f(Ljava/lang/String;)I
    ...
    invoke-static {p1, p0}, LX/05Q;->A03(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object p0

    invoke-static {v4, p0}, Lcom/whatsapp/yo/Conversation;->a(ZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v7, p0}, Lcom/whatsapp/yo/Conversation;->a(ZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p2}, LX/05Q;->A03(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public static ChangeSize(Landroid/widget/TextView;I)V
    ...
    :cond_0
    sget v0, Lcom/whatsapp/yo/yo;->i:I
    ...
    invoke-static {v2, v0}, Lcom/whatsapp/yo/shp;->getPrefInt(Ljava/lang/String;I)I
    ...
    sget v2, Lcom/whatsapp/yo/yo;->i:I
    ...
    sget-boolean p1, Lcom/whatsapp/yo/yo;->j:Z
...
.method public static H1(Landroid/view/ViewGroup;Landroid/app/Activity;)V
    ...
    instance-of p1, p1, Lcom/whatsapp/HomeActivity;
    ...
    :cond_0
    new-instance p1, Lcom/whatsapp/yo/-$$Lambda$yo$jhEfCa7LY0ZgXsKei5kJPuSmvBY;

    invoke-direct {p1, p0}, Lcom/whatsapp/yo/-$$Lambda$yo$jhEfCa7LY0ZgXsKei5kJPuSmvBY;-><init>(Landroid/view/ViewGroup;)V
...
.method public static H2()V
    ...
    sget-object v0, Lcom/whatsapp/yo/yo;->k:Landroid/widget/TextView;
    ...
    sget-object v1, Lcom/whatsapp/yo/-$$Lambda$yo$EEQMg9EHG8suZgEvxt-GxCAhG0U;->INSTANCE:Lcom/whatsapp/yo/-$$Lambda$yo$EEQMg9EHG8suZgEvxt-GxCAhG0U;
    ...
    sget-boolean v0, Lcom/whatsapp/yo/yo;->m:Z

    if-nez v0, :cond_3

    invoke-static {}, Lcom/whatsapp/yo/yo;->j()V
...
.method public static H3T(LX/1QA;)Z
    .locals 0
...
.method public static H3T(LX/254;)Z
    .locals 0

    invoke-static {p0}, Lcom/whatsapp/yo/dep;->getJID_t(Lcom/whatsapp/jid/Jid;)Ljava/lang/String;
...
.method public static H3T(Ljava/lang/String;)Z
    ...
    :cond_0
    sget-object v0, Lcom/whatsapp/yo/yo;->g:Ljava/util/LinkedHashSet;
...
.method public static H4N()Ljava/util/ArrayList;
    ...
    sget-object v1, Lcom/whatsapp/yo/yo;->h:Ljava/util/ArrayList;
    ...
    invoke-direct {v3}, LX/0qW;-><init>()V

    iput-object v2, v3, LX/0qW;->A01:LX/254;

    const-wide/16 v4, 0x0

    iput-wide v4, v3, LX/0qW;->A00:J
...
.method public static HCoN(Ljava/util/Set;)V
    ...
    :try_start_0
    sget-object v0, Lcom/whatsapp/yo/yo;->h:Ljava/util/ArrayList;
...
.method public static HNoNotif(LX/1DL;)Z
    .locals 2

    :try_start_0
    iget-object p0, p0, LX/1DL;->A09:Lcom/whatsapp/jid/Jid;
...
.method public static HNotifTitle(LX/1DL;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
...
.method public static HiActv(Landroid/app/Activity;)V
    ...
    sput-object p0, Lcom/whatsapp/yo/yo;->l:Landroid/app/Activity;
...
.method public static Home_onActivityResult(IILandroid/content/Intent;)V
    ...
    invoke-static {v0}, Lcom/whatsapp/yo/yo;->b(Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lcom/whatsapp/youbasha/task/utils;->isVideoFile(Landroid/net/Uri;)Z
    ...
    invoke-static {}, Lcom/whatsapp/yo/a;->a()Lcom/whatsapp/yo/a;
    ...
    invoke-virtual {v0, p2}, Lcom/whatsapp/yo/a;->a(Landroid/net/Uri;)V

    new-instance p2, Lcom/whatsapp/yo/b;

    sget-object v0, Lcom/whatsapp/yo/yo;->Homeac:Lcom/whatsapp/HomeActivity;

    invoke-direct {p2, v0}, Lcom/whatsapp/yo/b;-><init>(Landroid/app/Activity;)V

    invoke-virtual {p2}, Lcom/whatsapp/yo/b;->start()V
    ...
    :cond_5
    sget-object p0, Lcom/whatsapp/yo/yo;->r:Ljava/util/LinkedHashSet;

    invoke-static {p0}, Lcom/whatsapp/yo/yo;->a(Ljava/util/LinkedHashSet;)V

    sget-object p0, Lcom/whatsapp/yo/yo;->l:Landroid/app/Activity;

    invoke-static {p0}, Lcom/whatsapp/yo/yo;->c(Landroid/app/Activity;)V
    ...
    sget-object p1, Lcom/whatsapp/yo/yo;->h:Ljava/util/ArrayList;
    ...
    sget-object p2, Lcom/whatsapp/yo/yo;->g:Ljava/util/LinkedHashSet;
    ...
    sget-object p1, Lcom/whatsapp/yo/yo;->g:Ljava/util/LinkedHashSet;
    ...
    sget-object p0, Lcom/whatsapp/yo/yo;->Homeac:Lcom/whatsapp/HomeActivity;
...
.method public static SetDB(Landroid/database/sqlite/SQLiteOpenHelper;)V
    ...
    sput-object p0, Lcom/whatsapp/yo/yo;->c:Landroid/database/sqlite/SQLiteOpenHelper;

    return-void
.end method

.method public static SetMsgs(Ljava/lang/String;Lcom/whatsapp/GroupChatInfo;Landroid/view/View;)V
    .locals 2
    ...
    iget-object v0, p1, Lcom/whatsapp/GroupChatInfo;->Counter:Ljava/util/LinkedHashMap;
    ...
    :cond_1
    iget-object p1, p1, Lcom/whatsapp/GroupChatInfo;->Counter:Ljava/util/LinkedHashMap;
...
.method private static a(Ljava/lang/CharSequence;)Landroid/text/SpannableString;
    ...
    sget-object v2, Lcom/whatsapp/yo/shp;->f:Landroid/graphics/Typeface;

    const-string v4, ""

    invoke-direct {v1, v4, v2}, Lcom/whatsapp/yo/CustomTypefaceSpan;-><init>(Ljava/lang/String;Landroid/graphics/Typeface;)V
...
.method static a(LX/019;Ljava/lang/CharSequence;)V
    .locals 2
    ...
    invoke-static {p1}, Lcom/whatsapp/yo/yo;->a(Ljava/lang/CharSequence;)Landroid/text/SpannableString;

    move-result-object p1

    invoke-virtual {p0, p1}, LX/019;->A0D(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, p1}, LX/019;->A0C(Ljava/lang/CharSequence;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method static a(Landroid/content/Context;)V
    ...
    sput-object p0, Lcom/whatsapp/yo/yo;->d:Landroid/content/Context;
...
.method private static synthetic a(Landroid/view/View;)V
    ...
    sget-object p0, Lcom/whatsapp/yo/yo;->hideJidCode:Ljava/lang/String;

    invoke-static {p0}, Lcom/whatsapp/youbasha/ui/lockV2/LockUtils;->getLockTypeByJID(Ljava/lang/String;)Ljava/lang/Class;
    ...
    const-class v3, Lcom/whatsapp/HiddenConversationsActivity;

    invoke-direct {v1, v2, v3}, Landroid/content/Intent;-><init>(Landroid/content/Context;Ljava/lang/Class;)V

    new-instance v2, Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;

    invoke-direct {v2}, Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;-><init>()V

    invoke-virtual {v2, v0}, Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;->setJustCloseAfterSuccess(Z)Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;

    move-result-object v3

    sget-object v4, Lcom/whatsapp/yo/yo;->hideJidCode:Ljava/lang/String;

    invoke-virtual {v3, v4}, Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;->setJID(Ljava/lang/String;)Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;

    move-result-object v3

    invoke-virtual {v3, v0}, Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;->setChangePass(Z)Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;

    move-result-object v3

    invoke-virtual {v3, v0}, Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;->setDisableLock(Z)Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;

    move-result-object v3

    invoke-virtual {v3, v0}, Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;->setConversation(Z)Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;

    move-result-object v0

    invoke-virtual {v0, v1}, Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;->setPassedIntent(Landroid/content/Intent;)Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;
    ...
    invoke-virtual {v2}, Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;->getBundle()Landroid/os/Bundle;
    ...
    invoke-virtual {v0, p0}, Lcom/whatsapp/HomeActivity;->startActivity(Landroid/content/Intent;)V
...
.method private static synthetic a(Landroid/view/ViewGroup;)V
    ...
    sput-object p0, Lcom/whatsapp/yo/yo;->k:Landroid/widget/TextView;
...
.method private static a(Ljava/util/LinkedHashSet;)V
    ...
    sget-object v1, Lcom/whatsapp/yo/yo;->g:Ljava/util/LinkedHashSet;
    ...
    :cond_0
    sget-object p0, Lcom/whatsapp/yo/yo;->g:Ljava/util/LinkedHashSet;
    ...
    invoke-static {p0, v0}, Lcom/whatsapp/yo/shp;->setStringPriv(Ljava/lang/String;Ljava/lang/String;)V
...
.method private static synthetic a([Ljava/lang/String;Landroid/content/DialogInterface;IZ)V
    ...
    invoke-static {p0, p3}, Lcom/whatsapp/yo/shp;->setBooleanPriv(Ljava/lang/String;Z)V
...
.method private static synthetic a(Landroid/view/MenuItem;)Z
    ...
    sget-object v1, Lcom/whatsapp/yo/-$$Lambda$yo$Md7R5zCB5KJFqSWodHdTMZ2kr1g;->INSTANCE:Lcom/whatsapp/yo/-$$Lambda$yo$Md7R5zCB5KJFqSWodHdTMZ2kr1g;
    ...
    sget-object v1, Lcom/whatsapp/yo/-$$Lambda$yo$7pSJjRqE2ZfCAVLPZwwr9OawmGM;->INSTANCE:Lcom/whatsapp/yo/-$$Lambda$yo$7pSJjRqE2ZfCAVLPZwwr9OawmGM;
    ...
    :cond_0
    invoke-static {}, Lcom/whatsapp/yo/yo;->f()V
...
.method private static synthetic a(Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;Landroid/view/MenuItem;)Z
    .locals 3
    ...
    sget-object p1, Lcom/whatsapp/yo/yo;->Homeac:Lcom/whatsapp/HomeActivity;

    const/16 v1, 0x500

    invoke-virtual {p1, p0, v1}, Lcom/whatsapp/HomeActivity;->startActivityForResult(Landroid/content/Intent;I)V

    return v0
.end method

.method public static addHiOpt(Landroid/view/Menu;Lcom/whatsapp/ConversationsFragment;)V
    .locals 5
    ...
    invoke-virtual {v2, v3}, Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;->setDisableLock(Z)Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;

    move-result-object v2

    invoke-virtual {v2, v3}, Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;->setConversation(Z)Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;

    iget-object p1, p1, Lcom/whatsapp/ConversationsFragment;->A0P:Ljava/util/LinkedHashSet;

    sput-object p1, Lcom/whatsapp/yo/yo;->r:Ljava/util/LinkedHashSet;

    sget-boolean p1, Lcom/whatsapp/yo/yo;->q:Z
    ...
    new-instance p1, Lcom/whatsapp/yo/-$$Lambda$yo$Ynj0w8UnQENtbJgk4lvrkmDqS3g;

    invoke-direct {p1, v1}, Lcom/whatsapp/yo/-$$Lambda$yo$Ynj0w8UnQENtbJgk4lvrkmDqS3g;-><init>(Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;)V
    ...
    new-instance p1, Lcom/whatsapp/yo/-$$Lambda$yo$dqYNVorevJudizD5I4y7sJoc6Bo;

    invoke-direct {p1, v1}, Lcom/whatsapp/yo/-$$Lambda$yo$dqYNVorevJudizD5I4y7sJoc6Bo;-><init>(Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;)V

    invoke-interface {p0, p1}, Landroid/view/MenuItem;->setOnMenuItemClickListener(Landroid/view/MenuItem$OnMenuItemClickListener;)Landroid/view/MenuItem;

    move-result-object p0

    sput-object p0, Lcom/whatsapp/yo/yo;->p:Landroid/view/MenuItem;
...
.method static b(Landroid/app/Activity;)V
    ...
    const-string v2, "/WhatsApp/Media/WhatsApp Images/Sent/YoWEB-"
    ...
    const-class v2, Lcom/whatsapp/WebImagePicker;
...
.method private static synthetic b(Landroid/view/MenuItem;)Z
    ...
    const-class v1, Lcom/whatsapp/youbasha/ui/activity/CallsPrivacy;
...
.method private static synthetic b(Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;Landroid/view/MenuItem;)Z
    .locals 2
    ...
    invoke-static {v1}, Lcom/whatsapp/youbasha/ui/lockV2/LockUtils;->getLockTypeByJID(Ljava/lang/String;)Ljava/lang/Class;
    ...
    sget-object p1, Lcom/whatsapp/yo/yo;->l:Landroid/app/Activity;
...
.method public static bringYoFAB_Chats()V
    ...
    iget v0, v0, Lcom/whatsapp/HomeActivity;->A03:I
...
.method static c()V
    ...
    invoke-static {v0, v2}, Lcom/whatsapp/yo/shp;->setIntPriv(Ljava/lang/String;I)V
    ...
    sget-object v2, Lcom/whatsapp/yo/shp;->c:Landroid/content/SharedPreferences$Editor;
...
.method private static synthetic c(Landroid/view/MenuItem;)Z
    ...
    invoke-static {}, Lcom/whatsapp/yo/yo;->anyNum()V
...
.method public static clearWALogs()V
    ...
    sget-object v1, Lcom/whatsapp/yo/-$$Lambda$AuvQl7mzpTuCl6KGI2jmWCB7WvI;->INSTANCE:Lcom/whatsapp/yo/-$$Lambda$AuvQl7mzpTuCl6KGI2jmWCB7WvI;
...
.method static d(Ljava/lang/String;)I
    ...
    :try_start_0
    sget-object v1, Lcom/whatsapp/yo/yo;->f:Ljava/lang/Class;
...
.method private static e(Ljava/lang/String;)Ljava/util/LinkedHashMap;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    sget-object v1, Lcom/whatsapp/yo/yo;->c:Landroid/database/sqlite/SQLiteOpenHelper;
...
.method private static synthetic e(Landroid/view/MenuItem;)Z
    ...
    const-class v1, Lcom/whatsapp/youbasha/ui/YoSettings/AllSettings;
...
.method private static f(Ljava/lang/String;)I
    ...
    :try_start_0
    sget-object v1, Lcom/whatsapp/yo/yo;->e:Ljava/lang/Class;
...
.method private static f()V
    ...
    invoke-static {v1, v0}, Lcom/whatsapp/yo/shp;->setBooleanPriv(Ljava/lang/String;Z)V
...
.method public static getCtx()Landroid/content/Context;
    ...
    sget-object v0, Lcom/whatsapp/yo/yo;->d:Landroid/content/Context;
...
.method public static getMention()I
    .locals 2

    const-string v0, "mention_mark"
...
.method public static getNIcon(I)I
    ...
    invoke-static {v2, v3}, Lcom/whatsapp/yo/shp;->getStringPriv(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static getReadTick(II)I
    ...
    invoke-static {p0, p1}, Lcom/whatsapp/yo/yo;->getBubbleTick(II)I
...
.method private static h()Z
    ...
    invoke-static {v0, v1}, Lcom/whatsapp/yo/shp;->putInt(Ljava/lang/String;I)V
    :try_end_0
...
.method public static hHideOpt(Z)V
    ...
    sget-object v0, Lcom/whatsapp/yo/yo;->p:Landroid/view/MenuItem;
...
.method public static homeAfter_onResume()V
    ...
    invoke-static {v0, v1}, Lcom/whatsapp/yo/yo;->a(Landroid/app/Activity;Ljava/lang/String;)V
...
.method public static homeAfter_setContentView(Landroid/app/Activity;)V
    ...
    sput-object v1, Lcom/whatsapp/yo/yo;->Homeac:Lcom/whatsapp/HomeActivity;

    const-string v2, "WhatsApp"

    invoke-static {v1, v2}, Lcom/whatsapp/yo/yo;->a(Landroid/app/Activity;Ljava/lang/String;)V
    ...
    invoke-static {v1}, Lcom/whatsapp/yo/yo;->setHOp(Z)V
    ...
    invoke-static {v5}, Lcom/whatsapp/yo/shp;->getIntPriv(Ljava/lang/String;)I
    ...
    invoke-static {v5, v6}, Lcom/whatsapp/yo/shp;->setIntPriv(Ljava/lang/String;I)V

    :try_start_0
    new-instance v5, Lcom/whatsapp/youbasha/task/devMsg;

    invoke-direct {v5}, Lcom/whatsapp/youbasha/task/devMsg;-><init>()V

    sget-object v6, Landroid/os/AsyncTask;->THREAD_POOL_EXECUTOR:Ljava/util/concurrent/Executor;

    new-array v1, v1, [Ljava/lang/Void;

    invoke-virtual {v5, v6, v1}, Lcom/whatsapp/youbasha/task/devMsg;->executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v2, v4}, Lcom/whatsapp/yo/shp;->setStringPriv(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v1, Lcom/whatsapp/youbasha/task/changelog;

    invoke-direct {v1, p0}, Lcom/whatsapp/youbasha/task/changelog;-><init>(Landroid/app/Activity;)V

    invoke-static {}, Lcom/whatsapp/yo/yo;->g()V
    ...
    invoke-virtual {v2, v3}, Lcom/whatsapp/HomeActivity;->findViewById(I)Landroid/view/View;
...
.method private static i()V
    ...
    :cond_0
    sput-object v1, Lcom/whatsapp/yo/yo;->g:Ljava/util/LinkedHashSet;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/whatsapp/yo/yo;->h:Ljava/util/ArrayList;
    ...
    sget-object v2, Lcom/whatsapp/yo/yo;->h:Ljava/util/ArrayList;
...
.method private static j()V
    ...
    invoke-static {v0}, Lcom/whatsapp/service/YoHiddenService;->A00(Landroid/content/Context;)V
    ...
    invoke-static {}, Lcom/whatsapp/yo/yo;->k()V

    :cond_2
    if-eqz v3, :cond_4

    sget-object v0, Lcom/whatsapp/yo/yo;->n:Landroid/os/Vibrator;
    ...
    sput-object v0, Lcom/whatsapp/yo/yo;->n:Landroid/os/Vibrator;
    ...
    sget-object v1, Lcom/whatsapp/yo/yo;->n:Landroid/os/Vibrator;
...
.method private static k()V
    ...
    :try_start_0
    sget-object v0, Lcom/whatsapp/yo/yo;->o:Landroid/media/Ringtone;
    ...
    sput-object v0, Lcom/whatsapp/yo/yo;->o:Landroid/media/Ringtone;
...
.method public static synthetic lambda$7pSJjRqE2ZfCAVLPZwwr9OawmGM(Landroid/content/DialogInterface;I)V
    ...
    invoke-static {p0, p1}, Lcom/whatsapp/yo/yo;->b(Landroid/content/DialogInterface;I)V
...
.method public static synthetic lambda$AohLWb7ckjpGZ4W_t0GbQ4HBY7k([Ljava/lang/String;Landroid/content/DialogInterface;IZ)V
    ...
    invoke-static {p0, p1, p2, p3}, Lcom/whatsapp/yo/yo;->a([Ljava/lang/String;Landroid/content/DialogInterface;IZ)V
...
.method public static synthetic lambda$EEQMg9EHG8suZgEvxt-GxCAhG0U(Landroid/view/View;)V
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/yo;->a(Landroid/view/View;)V
...
.method public static synthetic lambda$Md7R5zCB5KJFqSWodHdTMZ2kr1g(Landroid/content/DialogInterface;I)V
    ...
    invoke-static {p0, p1}, Lcom/whatsapp/yo/yo;->c(Landroid/content/DialogInterface;I)V
...
.method public static synthetic lambda$QzpaGx0eI4n0JXdy6cni0HiHdAE(Landroid/content/DialogInterface;I)V
    ...
    invoke-static {p0, p1}, Lcom/whatsapp/yo/yo;->a(Landroid/content/DialogInterface;I)V

    return-void
.end method

.method public static synthetic lambda$Ynj0w8UnQENtbJgk4lvrkmDqS3g(Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;Landroid/view/MenuItem;)Z
    .locals 0

    invoke-static {p0, p1}, Lcom/whatsapp/yo/yo;->b(Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;Landroid/view/MenuItem;)Z
...
.method public static synthetic lambda$aeMkdz2b1wKLyHH-WUEDSJNnkPY(Landroid/view/MenuItem;)Z
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/yo;->c(Landroid/view/MenuItem;)Z
...
.method public static synthetic lambda$bK3qomI8C4CyFKutODjJLHW0jlY(Landroid/view/MenuItem;)Z
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/yo;->b(Landroid/view/MenuItem;)Z
...
.method public static synthetic lambda$dqYNVorevJudizD5I4y7sJoc6Bo(Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;Landroid/view/MenuItem;)Z
    .locals 0

    invoke-static {p0, p1}, Lcom/whatsapp/yo/yo;->a(Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;Landroid/view/MenuItem;)Z
...
.method public static synthetic lambda$jhEfCa7LY0ZgXsKei5kJPuSmvBY(Landroid/view/ViewGroup;)V
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/yo;->a(Landroid/view/ViewGroup;)V
...
.method public static synthetic lambda$kresPSGcxiRHyjn0xgTBUAQq8B4(Landroid/view/MenuItem;)Z
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/yo;->e(Landroid/view/MenuItem;)Z
...
.method public static synthetic lambda$sjlyoB2bYQK0v5z2_HzwQSrHQ6g(Landroid/view/MenuItem;)Z
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/yo;->d(Landroid/view/MenuItem;)Z
...
.method public static synthetic lambda$xVWu9qaslGVi75716cNBTLChtAo(Landroid/view/MenuItem;)Z
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/yo;->a(Landroid/view/MenuItem;)Z
...
.method public static manjatpagercolor()I
    .locals 3
...
.method public static manjatpagercolor2()I
    .locals 3
...
.method public static notifIn(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    invoke-virtual {v0, p0}, Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;->setPassedIntent(Landroid/content/Intent;)Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;

    move-result-object p0

    const/4 v1, 0x0

    invoke-virtual {p0, v1}, Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;->setJID(Ljava/lang/String;)Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;

    move-result-object p0

    const/4 v1, 0x0

    invoke-virtual {p0, v1}, Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;->setConversation(Z)Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;

    move-result-object p0

    invoke-virtual {p0, v1}, Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;->setDisableLock(Z)Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;

    move-result-object p0

    invoke-virtual {p0, v1}, Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;->setChangePass(Z)Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;

    move-result-object p0

    invoke-virtual {p0, v1}, Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;->setJustCloseAfterSuccess(Z)Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;
    ...
    invoke-virtual {v0}, Lcom/whatsapp/youbasha/ui/lockV2/LockOptions;->getBundle()Landroid/os/Bundle;
...
.method public static serverProps()V
    ...
    sget-object v1, Lcom/whatsapp/yo/shp;->c:Landroid/content/SharedPreferences$Editor;
...
.method public static setGID(Lcom/whatsapp/GroupChatInfo;Ljava/lang/Object;)V
    .locals 0
    ...
    invoke-static {p1}, Lcom/whatsapp/yo/yo;->e(Ljava/lang/String;)Ljava/util/LinkedHashMap;

    move-result-object p1

    iput-object p1, p0, Lcom/whatsapp/GroupChatInfo;->Counter:Ljava/util/LinkedHashMap;
...
.method public static setHOp(Z)V
    ...
    sput-boolean p0, Lcom/whatsapp/yo/yo;->q:Z
...
.method public static setHoMenu(Landroid/view/Menu;)V
    ...
    sget-object v4, Lcom/whatsapp/yo/-$$Lambda$yo$kresPSGcxiRHyjn0xgTBUAQq8B4;->INSTANCE:Lcom/whatsapp/yo/-$$Lambda$yo$kresPSGcxiRHyjn0xgTBUAQq8B4;
    ...
    sget-object v4, Lcom/whatsapp/yo/-$$Lambda$yo$sjlyoB2bYQK0v5z2_HzwQSrHQ6g;->INSTANCE:Lcom/whatsapp/yo/-$$Lambda$yo$sjlyoB2bYQK0v5z2_HzwQSrHQ6g;
    ...
    sget-object v4, Lcom/whatsapp/yo/-$$Lambda$yo$aeMkdz2b1wKLyHH-WUEDSJNnkPY;->INSTANCE:Lcom/whatsapp/yo/-$$Lambda$yo$aeMkdz2b1wKLyHH-WUEDSJNnkPY;
    ...
    sget-object v4, Lcom/whatsapp/yo/-$$Lambda$yo$bK3qomI8C4CyFKutODjJLHW0jlY;->INSTANCE:Lcom/whatsapp/yo/-$$Lambda$yo$bK3qomI8C4CyFKutODjJLHW0jlY;
    ...
    invoke-static {v1, v4}, Lcom/whatsapp/yo/yo;->getID(Ljava/lang/String;Ljava/lang/String;)I
    ...
    sget-object v1, Lcom/whatsapp/yo/-$$Lambda$yo$xVWu9qaslGVi75716cNBTLChtAo;->INSTANCE:Lcom/whatsapp/yo/-$$Lambda$yo$xVWu9qaslGVi75716cNBTLChtAo;

    invoke-interface {v0, v1}, Landroid/view/MenuItem;->setOnMenuItemClickListener(Landroid/view/MenuItem$OnMenuItemClickListener;)Landroid/view/MenuItem;

    move-result-object v0

    invoke-static {}, Lcom/whatsapp/yo/yo;->showAirplaneMode()Z
...
.method public static setLanguage()V
    ...
    :try_start_0
    sget-object v0, Lcom/whatsapp/yo/shp;->d:Landroid/content/SharedPreferences;
    ...
    sget-object v1, Lcom/whatsapp/yo/shp;->b:Landroid/content/SharedPreferences$Editor;
    ...
    :goto_2
    sget-object v2, Lcom/whatsapp/yo/shp;->b:Landroid/content/SharedPreferences$Editor;
    ...
    sput-object v0, Lcom/whatsapp/yo/yo;->d:Landroid/content/Context;
...
.method public static setSQPC(F)F
    ...
    invoke-static {v0}, Lcom/whatsapp/yo/yo;->setSQPC(I)I
...
.method public static setSQPC(Landroid/content/Context;F)F
    ...
    invoke-static {p1}, Lcom/whatsapp/yo/yo;->setSQPC(F)F
...
.method public static setStatusesFragment(Lcom/whatsapp/StatusesFragment;)V
    .locals 2
    ...
    new-instance v1, Lcom/whatsapp/youbasha/ui/views/IGStatusesFragment;

    invoke-direct {v1}, Lcom/whatsapp/youbasha/ui/views/IGStatusesFragment;-><init>()V

    sput-object v1, Lcom/whatsapp/yo/yo;->mIGStatusesFragment:Lcom/whatsapp/youbasha/ui/views/IGStatusesFragment;

    invoke-virtual {v1, p0}, Lcom/whatsapp/youbasha/ui/views/IGStatusesFragment;->setStatusesFragment(Lcom/whatsapp/StatusesFragment;)V

    sget-object p0, Lcom/whatsapp/yo/yo;->Homeac:Lcom/whatsapp/HomeActivity;

    invoke-virtual {p0}, Lcom/whatsapp/HomeActivity;->A08()LX/07o;

    move-result-object p0

    invoke-virtual {p0}, LX/07o;->A05()LX/083;

    move-result-object p0

    sget-object v1, Lcom/whatsapp/yo/yo;->mIGStatusesFragment:Lcom/whatsapp/youbasha/ui/views/IGStatusesFragment;

    invoke-virtual {p0, v0, v1}, LX/083;->A03(ILX/28X;)V

    invoke-virtual {p0}, LX/083;->A00()I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static showHChatsSettings(Landroid/app/Activity;)V
    ...
    new-instance v4, Lcom/whatsapp/yo/-$$Lambda$yo$AohLWb7ckjpGZ4W_t0GbQ4HBY7k;

    invoke-direct {v4, v2}, Lcom/whatsapp/yo/-$$Lambda$yo$AohLWb7ckjpGZ4W_t0GbQ4HBY7k;-><init>([Ljava/lang/String;)V
    ...
    sget-object v1, Lcom/whatsapp/yo/-$$Lambda$yo$QzpaGx0eI4n0JXdy6cni0HiHdAE;->INSTANCE:Lcom/whatsapp/yo/-$$Lambda$yo$QzpaGx0eI4n0JXdy6cni0HiHdAE;
...
.method public static statusSplitter()V
    ...
    sget-object v4, Lcom/whatsapp/yo/yo;->Homeac:Lcom/whatsapp/HomeActivity;
    ...
    sget-object v1, Lcom/whatsapp/yo/yo;->Homeac:Lcom/whatsapp/HomeActivity;

    const/16 v2, 0x505

    invoke-virtual {v1, v0, v2}, Lcom/whatsapp/HomeActivity;->startActivityForResult(Landroid/content/Intent;I)V
...
.method public static yo(Landroid/content/Context;)V
    ...
    invoke-static {}, Lcom/whatsapp/yo/shp;->a()V
    ...
    invoke-static {}, Lcom/whatsapp/yo/yo;->i()V

    new-instance p0, Ljava/util/HashMap;

    invoke-direct {p0}, Ljava/util/HashMap;-><init>()V

    sput-object p0, Lcom/whatsapp/yo/c;->a:Ljava/util/HashMap;

    invoke-static {}, Lcom/whatsapp/youbasha/ui/activity/CallsPrivacy;->getActiveList()Ljava/util/HashSet;

    move-result-object p0

    sput-object p0, Lcom/whatsapp/yo/dep;->callsList:Ljava/util/HashSet;

    invoke-static {}, Lcom/whatsapp/yo/dep;->b()V
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/shp;->getIntPriv(Ljava/lang/String;)I
    ...
    invoke-static {p0, v1}, Lcom/whatsapp/yo/shp;->setIntPriv(Ljava/lang/String;I)V
    ...
    :cond_3
    invoke-static {}, Lcom/whatsapp/yo/yo;->h()Z
...
.method public static yoHideReceipt(Ljava/lang/Object;)Z
    ...
    invoke-static {v0}, Lcom/whatsapp/yo/dep;->b(LX/1QA;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/yo;->a(Ljava/lang/Object;)Ljava/lang/String;
...
.method public static yoHideStatusView(Ljava/lang/Object;)Z
    .locals 3
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/SS;->a(LX/1QA;)V
